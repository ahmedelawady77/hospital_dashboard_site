...
@section('content')
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            ...
                            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                <div class="inner-column">
                                    <div class="image">
                                        <img src="{{URL::asset('assetswebsite/images/main-slider/doctors.webp')}}" alt=""/>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="{{URL::asset('assetswebsite/images/resource/Vertical.webp')}}" alt=""/>
                            </div>
                        </div>
                    </div>
    ...
    <section class="department-section-three">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        ...
                        @foreach($sections as $section)
                            <li data-tab="#tab-{{ $section->id }}" class="tab-btn active-btn">{{$section->name}}</li>           
                            @endforeach
                        </ul>
                    </div>
                    <!--Column-->
        ...
        <div class="tab {{ $index == 0 ? 'active-tab' : '' }}" id="tab-{{ $section->id }}">
            <div class="content">
                <h2>{{ $section->name }}</h2>
                <div class="title">{{ $section->english_name }}</div>
                <div class="text">
                ...
                <div class="two-column row clearfix">
                    <div class="column col-lg-6 col-md-6 col-sm-12">
                        <h3>01 - Service</h3>
                        <div class="column-text">Description of service 1 for {{ $section->name }}</div>
                    </div>
                    <div class="column col-lg-6 col-md-6 col-sm-12">
                        <h3>02 - Service</h3>
                        <div class="column-text">Description of service 2 for {{ $section->name }}</div>
                    </div>
                </div>
